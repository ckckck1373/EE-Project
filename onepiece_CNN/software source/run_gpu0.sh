...
python test.py --model model_pretrained/${num_screen}/net_F${nFeat}B${nResBlock}_epoch_${num_nEpochs}.pth --cuda --combo True --screen_num ${num_screen} --quan_param_path quan_param_path 
